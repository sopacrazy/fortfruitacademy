...
import { Apple, Lock, User, ArrowRight, AlertCircle } from 'lucide-react';
      ...
      <div className="bg-white w-full max-w-md rounded-3xl shadow-2xl overflow-hidden relative z-10 border border-gray-100">
        <div className="p-8 md:p-10">
          <div className="text-center mb-10">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-fort-100 text-fort-600 rounded-2xl mb-4 shadow-inner">
              <Apple size={32} />
            </div>
            <h1 className="text-2xl font-bold text-gray-800">Portal Fort Fruit</h1>
            <p className="text-gray-500 text-sm mt-2">Entre com suas credenciais corporativas para acessar os treinamentos.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                  <User size={20} className="text-gray-400 group-focus-within:text-fort-500 transition-colors" />
                </div>
                <input
                  type="text"
                  value={username}
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                  <Lock size={20} className="text-gray-400 group-focus-within:text-fort-500 transition-colors" />
                </div>
                <input
                  type="password"
                  value={password}
          ...
          <div className="mt-8 text-center">
            <a href="#" className="text-sm text-gray-400 hover:text-fort-600 transition-colors">
              Esqueceu sua senha?
            </a>
          </div>
        </div>
        ...
        <div className="bg-gray-50 p-4 text-center border-t border-gray-100">
          <p className="text-xs text-gray-400">
            &copy; {new Date().getFullYear()} Fort Fruit. Acesso Restrito.
          </p>
        </div>
      </div>
    </div>
